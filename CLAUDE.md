...
Portfolio artifact by Alan Byers for conversational UX / AI product interview discussion. Concept only: **not a Fidelity product, fictional data, no real accounts.** Every UI surface keeps the disclaimer "educational guidance, not individualized investment advice."
